...
public class LiveInnerData {
	private String extremeLossMargin;

	private String cm_ffm;
	...
	private String cm_adj_low_dt;

	private String closePrice;

	private String isExDateFlag;

	private String recordDate;

	private String cm_adj_high_dt;
	...
	public String getCm_adj_low_dt() {
	...
	public String getCm_adj_high_dt() {
	...
	public void setCm_ffm(String cm_ffm) {
		this.cm_ffm = cm_ffm;
	}
	...
	public void setCm_adj_low_dt(String cm_adj_low_dt) {
	...
	public void setIsExDateFlag(String isExDateFlag) {
	...
	public void setCm_adj_high_dt(String cm_adj_high_dt) {
